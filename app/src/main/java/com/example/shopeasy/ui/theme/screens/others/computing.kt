...
@Composable
fun computing(navController: NavHostController) {
    val uri1 = "https://www.jumia.co.ke/computing/"
    val uri2 = "https://jiji.co.ke/search?query=computing"
    val uri3 = "https://www.alibaba.com/trade/search?spm=a2700.galleryofferlist.pageModule_fy23_pc_search_bar.keydown__Enter&tab=all&searchText=computing"
    val uri4 = "https://www.aliexpress.com/w/wholesale-computing.html?spm=a2g0o.productlist.search.0"
    val uri5 = "https://www.kilimall.co.ke/new/commoditysearch?q=computing"
    Row(
        Modifier
            .fillMaxWidth()
            .height(30.dp)
        ...
        Text(" COMPUTING", textAlign = TextAlign.Center,
...
@Composable
fun computingprev() {
    computing(rememberNavController())
}