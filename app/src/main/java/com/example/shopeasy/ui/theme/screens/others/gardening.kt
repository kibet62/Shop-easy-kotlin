...
@Composable
fun gardening(navController: NavHostController) {
    val uri1 = "https://www.jumia.co.ke/patio-lawn-garden/"
    val uri2 = "https://jiji.co.ke/search?query=gardening"
    val uri3 = "https://www.alibaba.com/trade/search?spm=a2700.galleryofferlist.pageModule_fy23_pc_search_bar.keydown__Enter&tab=all&searchText=gardening"
    val uri4 = "https://www.aliexpress.com/w/wholesale-gardening.html?spm=a2g0o.productlist.search.0"
    val uri5 = "https://www.kilimall.co.ke/new/commoditysearch?q=gardening"
    Row(
        Modifier
            .fillMaxWidth()
            .height(30.dp)
        ...
        Text(" GARDENING", textAlign = TextAlign.Center,
...
@Composable
fun garedeningprev() {
    gardening(rememberNavController())
}