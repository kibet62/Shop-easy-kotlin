...
@Composable
fun kitchen(navController: NavHostController) {
    val uri1 = "https://www.jumia.co.ke/catalog/?q=kitchen+accessories"
    val uri2 = "https://jiji.co.ke/search?query=kitchen"
    val uri3 = "https://www.alibaba.com/trade/search?spm=a2700.galleryofferlist.pageModule_fy23_pc_search_bar.associationItem_pos_0&tab=all&searchText=kitchen+accessories"
    val uri4 = "https://www.aliexpress.com/w/wholesale-kitchen.html?spm=a2g0o.productlist.search.0"
    val uri5 = "https://www.kilimall.co.ke/new/commoditysearch?q=kitchen"
    Row(
        Modifier
            .fillMaxWidth()
            .height(30.dp)
        ...
        Text(" KITCHEN PRODUCTS", textAlign = TextAlign.Center,
