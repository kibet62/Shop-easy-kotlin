...
fun gaming(navController: NavHostController) {
    ...
    val uri4 = "https://www.aliexpress.com/w/wholesale-gaming.html?spm=a2g0o.productlist.search.0"
    val uri5 = "https://www.kilimall.co.ke/new/commoditysearch?q=gaming"
    Row(
        Modifier
            .fillMaxWidth()
            .height(30.dp)
        ...
        Text(" GAMING", textAlign = TextAlign.Center,
